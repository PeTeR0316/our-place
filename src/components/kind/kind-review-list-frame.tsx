...
const KindReviewListFrameStyle = styled.div`
    width: 100%;
...
const KindReviewListFrame = ({ place_name, subway, keyword, user_name, write_date, file_src}: ReviewProps) => {
    const reviewUrl = "https://our-place.s3.ap-northeast-2.amazonaws.com/write-img/";

    return (
        <KindReviewListFrameStyle>
...
export default KindReviewListFrame;